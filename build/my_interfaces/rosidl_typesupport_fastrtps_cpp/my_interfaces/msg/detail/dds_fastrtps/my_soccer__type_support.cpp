...
#include "my_interfaces/msg/detail/my_soccer__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::MySoccer & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::MySoccer & ros_message)
{
  // Member: linear_vel
  cdr >> ros_message.linear_vel;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::MySoccer;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::MySoccer *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::MySoccer *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MySoccer__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_interfaces::msg::MySoccer *>(
...
static size_t _MySoccer__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MySoccer(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MySoccer__callbacks = {
  "my_interfaces::msg",
  "MySoccer",
...
static rosidl_message_type_support_t _MySoccer__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MySoccer__callbacks,
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_MySoccer__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, MySoccer)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_MySoccer__handle;
}
