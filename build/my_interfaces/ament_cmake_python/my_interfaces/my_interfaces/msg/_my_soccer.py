...
class Metaclass_MySoccer(type):
    """Metaclass of message 'MySoccer'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.msg.MySoccer')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__my_soccer
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__my_soccer
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__my_soccer
            cls._TYPE_SUPPORT = module.type_support_msg__msg__my_soccer
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__my_soccer
...
class MySoccer(metaclass=Metaclass_MySoccer):
    """Message class 'MySoccer'."""
    ...
    def angular_vel(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'angular_vel' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
