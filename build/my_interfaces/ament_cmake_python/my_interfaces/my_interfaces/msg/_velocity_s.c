...
bool my_interfaces__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._velocity.Velocity", full_classname_dest, 36) == 0);
  }
  my_interfaces__msg__Velocity * ros_message = _ros_message;
  {  // linear
...
PyObject * my_interfaces__msg__velocity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._velocity");
